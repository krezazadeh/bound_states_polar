...
program bound_states_polar
    ...
    ! integer, parameter :: n_try_max = 100
    ...
    ! l = 4.0q0
    ! omegaI_start = 1.39446140733621345926489739538q0
    ! omegaI_start = 5.74597208810959024462122188810q0
    ! omegaI_start = 60.0q0

    ! l = 5.0q0
    ! omegaI_start = 1.27457872054584822057830809760q0
    ! omegaI_start = 3.96869350344300724145297837715q0
    ! omegaI_start = 13.7676744991191418052194173734q0
    ! omegaI_start = 140.0q0

    ! l = 6.0q0
    ! omegaI_start = 1.21101301662263334121432086152q0
    ! omegaI_start = 3.31560482270969167797647507245q0
    ! omegaI_start = 8.38935673379701165582495451567q0
    ! omegaI_start = 27.7853768541936546428114045088q0
    ! omegaI_start = 280.0q0
    ...
    omegaI_min = omegaI_start - 1.0q-4
    omegaI_max = omegaI_start + 1.0q-4
    delta_omegaI_start = abs(omegaI_max - omegaI_min)
    ...
    ! print *, omegaI_result, f_omegaI_result
    ...
    do while(delta_omegaI > delta_omegaI_tol)
        ...
        call process()
        f_omegaI = fomegaI()  ! Assume fomegaI() is a function returning a value for f_omegaI
...
function fomegaI()
    ...
    ! fomegaI = maxval(array_absW(1:n_array))

    fomegaI = sum(array_absW(1:n_array))/real(n_array, 16)

    ! fomegaI = 0.0q0
    ! do i = 1, n_array
    !     fomegaI = fomegaI + (real(array_Zm(i)) - real(array_Zp(i)))**2 + &
    !     (aimag(array_Zm(i)) - aimag(array_Zp(i)))**2
    ! end do
